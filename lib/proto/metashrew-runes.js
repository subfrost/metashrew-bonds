...
exports.AddressReceivedRunesResponse = exports.AddressReceivedRunesRequest = exports.AddressReceivedReceipt = exports.AddressReceivedAmount = exports.RunesResponse = exports.WalletResponse = exports.WalletRequest = exports.PaginationInput = exports.OutpointResponse = exports.Output = exports.Outpoint = exports.BalanceSheet = exports.BalanceSheetItem = exports.Rune = exports.RuneId = void 0;
...
// @generated message type with reflection information, may provide speed optimized methods
class AddressReceivedAmount$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.senderAddress.length)
            writer.tag(1, runtime_1.WireType.LengthDelimited).bytes(message.senderAddress);
        /* bytes amount = 2; */
        if (message.amount.length)
            writer.tag(2, runtime_1.WireType.LengthDelimited).bytes(message.amount);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.AddressReceivedAmount = new AddressReceivedAmount$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AddressReceivedReceipt$Type extends runtime_4.MessageType {
    constructor() {
        super("metashrew_runes.AddressReceivedReceipt", [
            { no: 1, name: "runeId", kind: "message", T: () => exports.RuneId },
            { no: 2, name: "amounts", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.AddressReceivedAmount }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated metashrew_runes.AddressReceivedAmount amounts */ 2:
                    message.amounts.push(exports.AddressReceivedAmount.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.amounts.length; i++)
            exports.AddressReceivedAmount.internalBinaryWrite(message.amounts[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.AddressReceivedReceipt = new AddressReceivedReceipt$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AddressReceivedRunesRequest$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.address.length)
            writer.tag(2, runtime_1.WireType.LengthDelimited).bytes(message.address);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.AddressReceivedRunesRequest = new AddressReceivedRunesRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AddressReceivedRunesResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("metashrew_runes.AddressReceivedRunesResponse", [
            { no: 1, name: "receipts", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.AddressReceivedReceipt }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated metashrew_runes.AddressReceivedReceipt receipts */ 1:
                    message.receipts.push(exports.AddressReceivedReceipt.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.receipts.length; i++)
            exports.AddressReceivedReceipt.internalBinaryWrite(message.receipts[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.AddressReceivedRunesResponse = new AddressReceivedRunesResponse$Type();
