...
// @generated message type with reflection information, may provide speed optimized methods
class MultisigReceivedAmount$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.MultisigReceivedAmount = new MultisigReceivedAmount$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MultisigReceivedReceiptItem$Type extends runtime_4.MessageType {
    constructor() {
        super("metashrew_runes.MultisigReceivedReceiptItem", [
            { no: 1, name: "runeId", kind: "message", T: () => exports.RuneId },
            { no: 2, name: "amounts", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MultisigReceivedAmount }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated metashrew_runes.MultisigReceivedAmount amounts */ 2:
                    message.amounts.push(exports.MultisigReceivedAmount.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.amounts.length; i++)
            exports.MultisigReceivedAmount.internalBinaryWrite(message.amounts[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MultisigReceivedReceiptItem = new MultisigReceivedReceiptItem$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MultisigReceivedReceipt$Type extends runtime_4.MessageType {
    constructor() {
        super("metashrew_runes.MultisigReceivedReceipt", [
            { no: 1, name: "data", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MultisigReceivedReceiptItem }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated metashrew_runes.MultisigReceivedReceiptItem data */ 1:
                    message.data.push(exports.MultisigReceivedReceiptItem.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.data.length; i++)
            exports.MultisigReceivedReceiptItem.internalBinaryWrite(message.data[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MultisigReceivedReceipt = new MultisigReceivedReceipt$Type();
